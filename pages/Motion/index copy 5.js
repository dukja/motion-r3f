...
export const ThreeDElement = forwardRef((props, ref) => {
  ...
  useEffect(() => {
    if (localRef.current && typeof window !== "undefined" && ScrollTrigger) {
      console.log("Setting up ThreeDElement animation");
        ...
        { x: -2.5 },
        {
          ...
          scrollTrigger: {
            ...
            onUpdate: (self) => {
              ...
              console.log("Current position:", localRef.current.position.x);
            },
          },
        }
      );
